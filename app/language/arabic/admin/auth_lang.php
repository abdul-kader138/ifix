...
$lang['login_email']                                =   "   الدخول الى البريد الاليكتروني   "   ;
...
$lang['captcha_wrong']                              =   "   كلمة السر غير صحيحة أو منتهية الصلاحية. الرجاء المحاولة مرة أخرى    "   ;
$lang['captcha']                                    =   "   رمز التحقق  "   ;
$lang['site_is_offline_plz_try_later']              =   "   الموقع في وضع الصيانه الرجاء العودة قريبا.  "   ;
$lang['type_captcha']                               =   "   أكتب رمز التحقق "   ;
$lang['we_are_sorry_as_this_sction_is_still_under_development'] =   "   هذا القطاع تحت التطوير نأسف لذلك    "   ;
$lang['confirm']                                    =   "   التأكيد "   ;
$lang['error_csrf']                                 =   "    الطلب عبر المواقع الكشف أو انتهت صلاحية الرمز المميز CSRF. يرجى المحاولة مرة أخرى. "   ;
$lang['avatar_updated']                             =   "   تم تحديث الصورة الرمزية بنجاح   "   ;
$lang['registration_is_disabled']                   =   "   التسجيل غير متاح حاليا. "   ;
...
$lang['no_user_selected']                           =   "   لم يتم اختيار مستخدم - الرجاء اختيار على الاقل مستخدم واحد. "   ;
$lang['delete_users']                               =   "   حذف المستخدمين  "   ;
$lang['delete_avatar']                              =   "   حذف الصورة  "   ;
$lang['deactivate_heading']                         =   "   هل أنت متأكد من تعطيل المستخدم؟ "   ;
$lang['deactivate']                                 =   "   عطل "   ;
$lang['pasword_hint']                               =   "   لابد للباسورد ان يحتوي حرف كبير أو رمز ورقم "   ;
...
$lang['forgot_password_email_not_found']            =   "   عنوان البريد الاليكترزني لا ينتمى الى اي حساب.  "   ;
$lang['login_unsuccessful']                         =   "   تسجيل الدخول فشل، يرجى المحاولة مرة أخرى    "   ;
$lang['email_forgot_password_link']                 =   "   رابط اعادة تعيين كلمة السر  "   ;
...
$lang['error_csrf']                                 =   "    هناك خطأ.  "   ;
$lang['account_creation_successful']                =   "   تم إنشاء الحساب بنجاح   "   ;
$lang['old_password_wrong']                         =   "   كلمة المرور القديمة غير صحيحة   "   ;
