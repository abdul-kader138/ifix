...
<div id="wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= admin_url() ?>"><span class="logo"><span
            ...
            <div class="header-nav">
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a class="btn account dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt=""
                                 src="<?= $this->session->userdata('avatar') ? base_url() . 'assets/uploads/avatars/thumbs/' . $this->session->userdata('avatar') : $assets . 'images/' . $this->session->userdata('gender') . '.png'; ?>"
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a class="btn bblue pos-tip" title="<?= lang('dashboard') ?>" data-placement="bottom"
                    ...
                    <?php if ($Owner) { ?>
                        <li class="dropdown hidden-sm">
                            <a class="btn pos-tip" title="<?= lang('settings') ?>" data-placement="bottom"
                    ...
                    ?>
                    <li class="dropdown hidden-sm">
                        <a class="btn bpink pos-tip" title="<?= lang('POS Sales') ?>" data-placement="bottom"
                               href="<?= admin_url('pos/sales') ?>">
                                <i class="fa fa-dollar"></i>
                                <span class="padding05"><?= lang('SALES') ?>
                                </span>
                        </a>
                    </li>
                    <li class="dropdown hidden-sm">
                        <a class="btn bblue pos-tip" title="<?= lang('List Repairs') ?>"
                               data-placement="bottom"
                               href="<?= admin_url('sales/repair_list') ?>">
                                <i class="fa fa-wrench"></i>
                                <span class="padding05"><?= lang('REPAIRS') ?>
                                </span>
                        </a>
                    </li>
                    <li class="dropdown hidden-xs">
                        <a class="btn bdarkGreen pos-tip" title="<?= lang('Customers') ?>"
                            data-placement="bottom"
                    ...
                    <li class="dropdown hidden-xs">
                        <a class="btn bred pos-tip" title="<?= lang('List Reward Cards') ?>"
                            data-placement="bottom"
                    ...
                    <li class="dropdown hidden-xs">
                        <a class="btn borange pos-tip" title="<?= lang('List Products') ?>"
                            data-placement="bottom"
                    ...
                    <li class="dropdown hidden-xs">
                        <a class="btn pos-tip" title="<?= lang('calculator') ?>" data-placement="bottom" href="#"
                    ...
                    <li class="dropdown hidden-sm">
                        <a class="btn pos-tip" title="<?= lang('shortcuts') ?>" data-placement="bottom" href="#"
                           data-toggle="modal" data-target="#sckModal">
                            <i class="fa fa-key"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn pos-tip" title="<?= lang('view_bill_screen') ?>" data-placement="bottom"
                           href="<?= admin_url('pos/view_bill') ?>" target="_blank">
                            <i class="fa fa-laptop"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn blightOrange pos-tip" id="opened_bills"
                           title="<span><?= lang('suspended_sales') ?></span>" data-placement="bottom" data-html="true"
                           href="<?= admin_url('pos/opened_bills') ?>" data-toggle="ajax">
                            <i class="fa fa-th"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn bdarkGreen pos-tip" id="register_details"
                           title="<span><?= lang('register_details') ?></span>" data-placement="bottom" data-html="true"
                           href="<?= admin_url('pos/register_details') ?>" data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-check-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="close_register"
                           title="<span><?= lang('close_register') ?></span>" data-placement="bottom" data-html="true"
                           data-backdrop="static" href="<?= admin_url('pos/close_register') ?>" data-toggle="modal"
                           data-target="#myModal">
                            <i class="fa fa-times-circle"></i>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a class="btn borange pos-tip" id="add_expense" title="<span><?= lang('add_expense') ?></span>"
                           data-placement="bottom" data-html="true" href="<?= admin_url('purchases/add_expense') ?>"
                    ...
                    <?php if ($Owner) { ?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_profit"
                               title="<span><?= lang('today_profit') ?></span>" data-placement="bottom" data-html="true"
                               href="<?= admin_url('reports/profit') ?>" data-toggle="modal" data-target="#myModal">
                    ...
                    <?php if ($Owner || $Admin) { ?>
                        <li class="dropdown">
                            <a class="btn bdarkGreen pos-tip" id="today_sale"
                        ...
                        <li class="dropdown hidden-xs">
                            <a class="btn bblue pos-tip" title="<?= lang('list_open_registers') ?>"
                    ...
                    ?>
                    <li class="dropdown hidden-xs">
                        <a class="btn bred pos-tip" title="<?= lang('clear_ls') ?>" data-placement="bottom" id="clearLS"
                           href="#">
                    ...
                    <div id="leftdiv">
                                ...
                                <div class="form-group" id="ui">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-addon" style="padding: 2px 8px;">
                                            <a title="" data-placement="bottom" data-html="true"
                                               data-backdrop="static" href="<?= admin_url('pos/update_product') ?>"
                                               data-toggle="modal"
                                               data-target="#myModal">
                                                <i class="fa fa-plus-circle" id="addIcon" style="font-size: 1.5em;"></i>
                                            </a>
                        ...
                        <div id="print">
                            ...
                            <div id="left-bottom">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4" style="padding: 0;">
                                            <button type="button" class="btn btn-success btn-block" id="payment"
                                                    style="height:67px;">
                                                <i class="fa fa-money"
                                                   style="margin-right: 5px;"></i><?= lang('payment'); ?>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="repair_note_h" value="" id="repair_note_h">
                                <input type="hidden" name="tech_id_h" value="" id="tech_id_h">
                                <input type="hidden" name="type_h" value="" id="type_h">
                                <input type="hidden" name="type_detail_h" value="" id="type_detail_h">
                                ...
                                <input name="order_tax" type="hidden"
                                       value="<?= $suspend_sale ? $suspend_sale->order_tax_id : ($old_sale ? $old_sale->order_tax_id : $Settings->default_tax_rate2); ?>"
                                       id="postax2">
                                <input name="discount" type="hidden"
                                       value="<?= $suspend_sale ? $suspend_sale->order_discount_id : ($old_sale ? $old_sale->order_discount_id : ''); ?>"
                                       id="posdiscount">
                                <input name="shipping" type="hidden"
                                       value="<?= $suspend_sale ? $suspend_sale->shipping : ($old_sale ? $old_sale->shipping : '0'); ?>"
                                       id="posshipping">
                                ...
                                <div id="proContainer">
                                    <div id="ajaxproducts">
                                        ...
                                        <div class="btn-group btn-group-justified pos-grid-nav">
                                            <div class="btn-group">
                                                <button style="z-index:10002;" class="btn btn-primary pos-tip"
                                            ...
                                            <?php if ($Owner || $Admin || $GP['sales-add_gift_card']) { ?>
                                                <div class="btn-group">
                                                    <button style="z-index:10003;" class="btn btn-primary pos-tip"
                                                            type="button" id="sellGiftCard"
                                                            title="<?= lang('sell_gift_card') ?>">
                                                        <i class="fa fa-credit-card"
                                                           id="addIcon"></i> <?= lang('sell_gift_card') ?>
                                                    </button>
                                                </div>
                                            <?php }
                                            ?>
                                            <div class="btn-group">
                                                <button style="z-index:10004;" class="btn btn-primary pos-tip"
...
<div class="rotate btn-cat-con">
    ...
    <button type="button" id="open-subcategory"
            class="btn btn-warning open-subcategory"><?= lang('subcategories'); ?></button>
                    ...
                    <div class="col-md-10 col-sm-9">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    <?= lang("Type", "Type") . "<b> *</b>"; ?>
                                    <?php $sst = array('1' => lang('Select_Type'), 'Sales' => lang('Sales'), 'Repair' => lang('Repair'));
                                    echo form_dropdown('type', $sst, (isset($_POST['type']) ? $_POST['type'] : ""), 'class="form-control input-tip" required="required" id="type" style="width:100%"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="well well-sm well_1" "form-group" id="repair_info" style="display: none">
                            <div class="row">
                                <div class="col-sm-3" id="type_details">
                                    <?= lang("Repair Status", "Repair Status") . "<b> *</b>"; ?>
                                    <?php $sst = array('In Progress' => lang('In Progress'),
                                        'Waiting for Parts' => lang('Waiting for Parts'),
                                        'Ready' => lang('Ready'),
                                        'Return/Not Fixable' => lang('Return/Not Fixable'),
                                        'Delivered' => lang('Delivered'));
                                    echo form_dropdown('type_detail', $sst, (isset($_POST['type_detail']) ? $_POST['type_detail'] : ""), 'class="form-control input-tip" required="required" id="type_detail" style="width:100%"'); ?>

                                </div>
                                <div class="col-sm-4">
                                    <?= lang("Technician", "Technician") . "<b> *</b>"; ?>
                                    <div class="form-group">
                                        <?php
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?= form_textarea('repair_note', '', 'id="repair_note" class="form-control kb-text skip" style="height: 100px;" placeholder="' . lang('Repair_Note') . '" maxlength="250"'); ?>
                                </div>
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control kb-pad"
...
<script type="text/javascript">
    var product_variant = 0, shipping = 0, p_page = 0, per_page = 0, tcp = "<?=$tcp?>",
        ...
        ocat_id = "<?=$pos_settings->default_category?>", sub_cat_id = 0, osub_cat_id,
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '.paid_by', function () {
            ...
            if (p_val == 'cash' || p_val == 'other') {
                ...
                $('.pcash_' + pa_no).show();
                $('#amount_' + pa_no).focus();
            } else if (p_val == 'CC' || p_val == 'Debit_Card' || p_val == 'stripe' || p_val == 'ppp' || p_val == 'authorize') {
                $('.pcheque_' + pa_no).hide();
                $('.pcash_' + pa_no).hide();
                $('.pcc_' + pa_no).show();
                $('#swipe_' + pa_no).focus();
        ...
        $(document).on('click', '#submit-sale', function () {
            ...
            if (types == '1') {
                bootbox.alert('<?=lang('Please select type')?>');
                return false;
            }
            if (tech_id == 'test' && types !='Sales') {
                bootbox.alert('<?=lang('Please select Technician')?>');
                return false;
            }

            if (($('#paid_by_1').val() == 'Debit_Card' || $('#paid_by_1').val() =='CC') &&  $('#pcc_no_1').val() ==''){
            ...
            if (total_paid == 0 || total_paid < grand_total) {
                bootbox.confirm("<?=lang('paid_l_t_payable');?>", function (res) {
                    if (res == true) {
                        ...
                        $('#repair_note_h').val($('#repair_note').val());
                        $('#tech_id_h').val($('#tech_id').val());
                        $('#type_h').val($('#type').val());
                        $('#type_detail_h').val($('#type_detail').val());
    ...
    $(document).ready(function () {
        ...
        $('#type').on('change', function () {
            if (this.value === 'Sales') $('#repair_info').hide();
